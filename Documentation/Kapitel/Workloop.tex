...
Abbildung \ref{fig:MonokameraEntfernung3} zeigt hierbei die entstehende Aufnahme des Verfahrens, sowie eine  Positionsschätzung des Objekts. Die Parameter wurden realitätsgetreu folgendermaßen gewählt: 
\begin{table}
\begin{tabular}{lcr}
\toprule
...
\todo{Skizze der Positionsverfolgung}
