...
\begin{figure}[h]
\centering
%\includegraphics[width=0.25\textwidth]{Bilder/Software/UMLActivity}
\todo{Diagram von MainActicity, Activity, CleenrBrain, NxtTalker}
...
\centering
%\includegraphics[width=0.25\textwidth]{Bilder/Software/UMLActivity}
\todo{Diagram von FocusObject, ValidFocus, NoFocus und FocusObjectFinder}
...
\centering
%\includegraphics[width=0.25\textwidth]{Bilder/Software/UMLActivity}
\todo{Diagram von FocusObject, Catregory, Color, Shape}
...
Die Arbeitsphasen sind separat als eigene Klassen modelliert, die sich von einer abstrakten Klasse \textit{WorkPhase} ableiten. Jede Arbeitsphase verfügt über eine virtuelle \textit{executeWork}-Methode, welche Zugriff auf alle für die Arbeitsphase relevanten Operationen besitzt. Darunter zählen Steuerwerk des Roboters, eine Referenz auf das aktuelle Fokusobjekt und einer Möglichkeit die Arbeitsphase zu wechseln. Die Implementierung der \textit{PickingUpObject}-Klasse ist in Listing \ref{lst:Pickup} zu sehen. Es ist deutlich zu sehen, dass der Code durch die hinzugefügte Abstraktionsebene sehr einfach gehalten werden kann.
